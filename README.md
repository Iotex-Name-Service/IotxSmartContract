...
IotxSmartContract Smart Contract Deployment

For documentation on the IotxSmartContract system, see https://iotx.domains/
...
Next, if you take a look at contracts/, you should be able to find SmartContract.sol:
...
Run it with npx hardhat run scripts/scripts.js
